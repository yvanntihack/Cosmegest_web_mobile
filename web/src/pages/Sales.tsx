...
export default function Sales() {
        ...
        <head>
          ...
          <style>
            * { box-sizing: border-box; }
            ...
            /* Ticket thermique 80 mm : lisible, compact et sans couleurs. */
            ...
            .invoice-sheet { width: 74mm; max-width: 74mm; padding: 0; border: 0; }
            .header {
              display: block;
              padding-bottom: 8px;
  ...
  const displayedInvoices = useMemo(() => {
    return [...pendingInvoices, ...(filteredBaseInvoices as Invoice[])];
  }, [pendingInvoices, filteredBaseInvoices]);
